...
// Test 2: Comparing true and null
// Since both arguments are not strings, they are converted to numbers.
// true is converted to 1, null is converted to 0.
...
// 0 is equal to 0, not less than or equal to 0.
...
// 'a' comes before 'b', so 'aa' is less than or equal to 'ab'.
const _7_expect = true;
const _7_native = 'aa' <= 'ab';
console.assert(_7_expect === _7_native, 'Test 7');

// Test 8: Comparing 'aa' and 'aa'
// Both strings are the same, so 'aa' is equal to 'aa'.
